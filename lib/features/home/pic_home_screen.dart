...
class _PicHomeScreenState extends State<PicHomeScreen> {
                    ...
                    if (_isLoading)
                      ...
                      if (_pastOrders.isNotEmpty) ...[
                        ...
                        _buildOrderGroup(
                          ...
                          emptyDescription:
                              'Orderan yang sudah lewat akan tampil di sini.',
                          showAllAction: false,
                        ),
                      ],
                    ],
                ...
                children: [
                  ...
                  Text(
                    total == 0
                        ...
                        : 'Total $total orderan tercatat di sistem',
                    style: theme.textTheme.bodySmall?.copyWith(
                      color: colors.onSurfaceVariant,
                    ),
                  ),
  ...
  Widget _buildOrderGroup(
    ...
    required List<OrderanSewa> orders,
    required String emptyMessage,
    required String emptyDescription,
    required bool showAllAction,
  }) {
    final theme = Theme.of(context);
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
